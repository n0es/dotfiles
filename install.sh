...
PACKAGES="hyprland waybar kitty rofi yazi ranger stow git zsh tmux pipewire wireplumber pipewire-pulse pipewire-alsa pipewire-audio xdg-desktop-portal-hyprland github-cli swaybg eza bat jq socat imagemagick wtype zsh-autosuggestions zsh-syntax-highlighting"
